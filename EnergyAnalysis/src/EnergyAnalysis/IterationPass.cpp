#include "IterationPass.h"




namespace IterationPass {
...
char IterationPass::LoopIter::ID = 0;
static llvm::RegisterPass<IterationPass::LoopIter> X("LoopCount", "Counts number of loops per program", false, false);