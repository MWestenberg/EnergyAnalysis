...
void AnnotationPass::AddAnnotation(const llvm::Module &M) {
...
void AnnotationPass::Tokenize(std::vector<llvm::StringRef>& tokens, const llvm::StringRef& text, char sep)
{
...
void AnnotationPass::SetEnergyFunctions(llvm::Module &M)
{
...
llvm::Function* AnnotationPass::GetEnergyFunction(const llvm::Function& fn)
{
...
// functions
void AnnotationPass::PrintAnnotations(llvm::Module& M) const
{
