...
void soundSystemOn() __attribute__((annotate("15,20,0")));
void soundSystemOff() __attribute__((annotate("15,20,0")));
void playBeep(float Mhz) __attribute__((annotate("15,20,0")));
void sleepABit(int seconds) __attribute__((annotate("15,20,0")));
