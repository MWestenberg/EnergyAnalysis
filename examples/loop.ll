...
define i32 @doubleIt(i32) local_unnamed_addr #0 {
  %2 = shl nsw i32 %0, 1                          ; x + x
  ret i32 %2
}

; Function Attrs: nounwind ssp uwtable
define i32 @main(i32, i8** nocapture readonly) local_unnamed_addr #1 {
  %3 = icmp eq i32 %0, 2                          ; argc == 2 ?
  br i1 %3, label %4, label %17                   ; true %4 else %17

; <label>:4:                                      ; preds = %2
  %5 = getelementptr inbounds i8*, i8** %1, i64 1 ; get pointer
  %6 = load i8*, i8** %5, align 8, !tbaa !3       ; load values
  %7 = icmp eq i8* %6, nonnull                    ; argv[1] != NULL
  br i1 %7, label %17, label %8                   ; true %17 else %8

; <label>:8:                                      ; preds = %4
  %9 = tail call i32 @atoi(i8* nonnull %6)        ; atoi function
  %10 = icmp slt i32 %9, 10                       ; x < 10 ? true : false
  br i1 %10, label %11, label %17                 ; %10 ? true -> %11 else %17

; <label>:11:                                     ; preds = %8
  br label %12                                    ; unconditional branch, nessecary for the phi function (only labels are allowed)

; <label>:12:                                     ; preds = %11, %12
  %13 = phi i32 [ %14, %12 ], [ %9, %11 ]         ; if predecessor is %12 , %13 <- %14, else if preds %11, %13 <- %9
  %14 = shl nsw i32 %13, 1                        ; this should call doubleIt but the optimizer does the same as the function by doing shl 1
  %15 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %14) ; printf function
  %16 = icmp slt i32 %13, 5                       ; %13 < 5 ? true : false (remember 5+5 = 10)
  br i1 %16, label %12, label %17                 ; %16 ? true -> %12 else %17
