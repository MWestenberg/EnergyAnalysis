...
@.str.1 = private unnamed_addr constant [13 x i8] c"loopbranch.c\00", section "llvm.metadata"
...
; <label>:6:                                      ; preds = %2, %25
  %7 = phi i64 [ %26, %25 ], [ 0, %2 ]
  tail call void @LOOP_TRIPCOUNT(i32 5) #5
...
declare dso_local void @LOOP_TRIPCOUNT(i32) local_unnamed_addr #3
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #1 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %4, i8* align 16 bitcast ([4 x i32]* @main.a to i8*), i64 16, i1 false)
  %5 = getelementptr inbounds [4 x i32], [4 x i32]* %3, i64 0, i64 0
  call void @loop(i32* nonnull %5, i64 4)
