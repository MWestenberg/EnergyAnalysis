; ModuleID = 'VAF-example.c'
source_filename = "VAF-example.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

@.str = private unnamed_addr constant [12 x i8] c"Hello world\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"Result: %d\00", align 1

; Function Attrs: nounwind ssp uwtable
define i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0))
  %2 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 40)
  ret i32 0
}
...
define i32 @doSomething(i32, i32) local_unnamed_addr #2 {
  %3 = shl i32 %0, 1
  %4 = mul i32 %3, %1
  ret i32 %4
}
