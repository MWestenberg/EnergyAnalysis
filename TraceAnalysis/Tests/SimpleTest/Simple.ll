; ModuleID = 'SimpleTest\Simple.c'
source_filename = "SimpleTest\5CSimple.c"
...
@.str.1 = private unnamed_addr constant [20 x i8] c"SimpleTest\5CSimple.c\00", section "llvm.metadata"
...
entry:
  ...
  tail call void (i32, ...) @delayOff(i32 8000) #3
  ret void
}
...
entry:
  ...
  tail call void (i32, ...) @delayOn(i32 20000) #3
  ret void
}
